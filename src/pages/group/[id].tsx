...
const GroupView: React.FC = () => {
  ...
  const { data: group, isLoading: loadingGroup } = api.group.get.useQuery(groupId)
	...
	return (
		<>
			...
			<div className="flex flex-col gap-3">
				{isCreateTask && (
					<CreateTaskForm groupId={group.id} onCancel={handleShowTaskCreate} onCreated={handleShowTaskCreate} />
				)}
